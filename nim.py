...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        update_q = old_q + self.alpha * (new_value_est - old_q)
        self.q[(state_tuple, action)] = update_q
    ...
    def choose_action(self, state, epsilon=True):
        ...
        q_values = [(self.get_q_value(state, action), action) for action in actions]
...
def save_ai(ai, filename="nim_ai.pkl"):
    with open(filename, "wb") as f:
        pickle.dump(ai.q, f)


def load_ai(filename="nim_ai.pkl"):
    ai = NimAI()
